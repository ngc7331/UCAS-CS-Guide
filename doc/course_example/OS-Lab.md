...
## 环境搭建
### **注**
- **[2022.12.01更新] 在 Project 5 网卡驱动实验中，wsl 和 vmware 会出现 `make run-net` 启动 QEMU 模拟器很慢（>2min）的问题，严重影响调试。原因是它执行了非常多次 DHCP 广播操作，进一步的原因尚不明确，暂无解决方法。建议同学们从一开始就按建议使用 virtual box**
